...
import cn.tojoy.chat.kit.IMConnectionStatusViewModel;
import cn.tojoy.chat.kit.IMServiceStatusViewModel;
import cn.tojoy.chat.kit.WfcBaseActivity;
import cn.tojoy.chat.kit.WfcScheme;
import cn.tojoy.chat.kit.WfcUIKit;
import cn.tojoy.chat.kit.channel.ChannelInfoActivity;
import cn.tojoy.chat.kit.contact.ContactListFragment;
import cn.tojoy.chat.kit.contact.ContactViewModel;
import cn.tojoy.chat.kit.contact.newfriend.SearchUserActivity;
import cn.tojoy.chat.kit.conversation.CreateConversationActivity;
import cn.tojoy.chat.kit.conversationlist.ConversationListFragment;
import cn.tojoy.chat.kit.conversationlist.ConversationListViewModel;
import cn.tojoy.chat.kit.conversationlist.ConversationListViewModelFactory;
import cn.tojoy.chat.kit.group.GroupInfoActivity;
import cn.tojoy.chat.kit.net.OKHttpHelper;
import cn.tojoy.chat.kit.qrcode.ScanQRCodeActivity;
import cn.tojoy.chat.kit.search.SearchPortalActivity;
import cn.tojoy.chat.kit.user.ChangeMyNameActivity;
import cn.tojoy.chat.kit.user.UserInfoActivity;
import cn.tojoy.chat.kit.user.UserViewModel;
import cn.tojoy.chat.kit.viewmodel.MessageViewModel;
import cn.tojoy.chat.kit.widget.ViewPagerFixed;
        ...
        switch (requestCode) {
            ...
            case REQUEST_IGNORE_BATTERY_CODE:
                if (resultCode == RESULT_CANCELED) {
                    Toast.makeText(this, "允许老板云IM后台运行，更能保证消息的实时性", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
