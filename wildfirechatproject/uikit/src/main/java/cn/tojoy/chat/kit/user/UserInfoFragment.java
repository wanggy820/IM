...
package cn.tojoy.chat.kit.user;
...
import cn.tojoy.chat.kit.contact.newfriend.InviteFriendActivity;
import cn.tojoy.chat.kit.conversation.ConversationActivity;
import cn.tojoy.chat.kit.qrcode.QRCodeActivity;
import cn.tojoy.chat.kit.third.utils.ImageUtils;
...
public class UserInfoFragment extends Fragment {
    ...
    private void setUserInfo(UserInfo userInfo) {
        ...
        accountTextView.setText("老板云ID:" + userInfo.name);
    }
