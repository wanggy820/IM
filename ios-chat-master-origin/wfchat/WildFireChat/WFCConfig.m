...
NSString *IM_SERVER_HOST = @"47.93.136.131";//@"wildfirechat.net";
...
NSString *APP_SERVER_ADDRESS = @"http://47.93.136.131:8888";//@"https://app.wildfirechat.net";
...
NSString *USER_PRIVACY_URL = @"https://h5.tojoyboss.com/tojoybossapp/agreement-secrecy.html";
NSString *USER_AGREEMENT_URL = @"https://h5.tojoyboss.com/tojoybossapp/agreement-privacy.html";
