...
import cn.tojoy.chat.kit.channel.ChannelViewModel;
import cn.tojoy.chat.kit.chatroom.ChatRoomViewModel;
import cn.tojoy.chat.kit.common.OperateResult;
import cn.tojoy.chat.kit.conversation.ext.core.ConversationExtension;
import cn.tojoy.chat.kit.conversation.mention.MentionSpan;
import cn.tojoy.chat.kit.conversation.message.model.UiMessage;
import cn.tojoy.chat.kit.conversation.multimsg.MultiMessageAction;
import cn.tojoy.chat.kit.conversation.multimsg.MultiMessageActionManager;
...
import cn.tojoy.chat.kit.viewmodel.SettingViewModel;
import cn.tojoy.chat.kit.widget.InputAwareLayout;
import cn.tojoy.chat.kit.widget.KeyboardAwareLinearLayout;
...
//        }
    ...
    public void pickGroupMemberToVoipChat(boolean isAudioOnly) {
        ...
        intent.putExtra("maxCount", TJIMSDK.TJ_MAX_PARTICIPANT_COUNT);
