...
package cn.tojoy.chat.kit.conversationlist;
...
import cn.tojoy.chat.kit.conversationlist.notification.ConnectionStatusNotification;
import cn.tojoy.chat.kit.conversationlist.notification.PCOnlineStatusNotification;
import cn.tojoy.chat.kit.conversationlist.notification.StatusNotificationViewModel;
...
import cn.tojoy.chat.kit.widget.ProgressFragment;
        ...
        settingViewModel.settingUpdatedLiveData().observe(this, o -> {
            ...
            if (infos.size() > 0) {
                for (PCOnlineInfo info : infos) {
                    ...
                    SharedPreferences sp = getActivity().getSharedPreferences("user.config", Context.MODE_PRIVATE);
