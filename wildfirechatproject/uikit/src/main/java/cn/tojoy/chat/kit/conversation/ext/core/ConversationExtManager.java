...
package cn.tojoy.chat.kit.conversation.ext.core;

import java.lang.reflect.Constructor;
import java.util.ArrayList;
import java.util.List;

import cn.tojoy.chat.kit.conversation.ext.ExampleAudioInputExt;
import cn.tojoy.chat.kit.conversation.ext.FileExt;
import cn.tojoy.chat.kit.conversation.ext.ImageExt;
import cn.tojoy.chat.kit.conversation.ext.LocationExt;
import cn.tojoy.chat.kit.conversation.ext.ShootExt;
import cn.tojoy.chat.kit.conversation.ext.UserCardExt;
import cn.tojoy.chat.kit.conversation.ext.VoipExt;
