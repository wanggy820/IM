...
//            }
     ...
     * @param callback
     */
    public Message sendMessage(Conversation conversation, MessageContent content, String[] toUsers, int expireDuration, SendMessageCallback callback) {
        Message msg = new Message();
        msg.conversation = conversation;
        msg.content = content;
        msg.toUsers = toUsers;
        return sendMessage(msg, expireDuration, callback);
    }
     ...
     */
    public Message sendMessage(final Message msg, final SendMessageCallback callback) {
        return sendMessage(msg, 0, callback);
    }
     ...
     */
    public Message sendMessage(final Message msg, final int expireDuration, final SendMessageCallback callback) {
        Log.v(TAG, "发送消息：" + msg.content);
    ...
    private void registerCoreMessageContents() {
        ...
        registerMessageContent(TJCallByeMessageContent.class);
        registerMessageContent(TJCallAnswerTMessageContent.class);
    }
